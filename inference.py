...
def main():
    ...
    parser.add_argument("--model_path", type=str, default="./output_model/output_model_acclerate", help="Path to the trained model")
    ...
    parser.add_argument("--output_dir", type=str, default="./generated_images/dogbackpack_accelerate/backpack", help="Output directory")
